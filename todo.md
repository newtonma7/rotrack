...
| M4 preferences and completed history | **Implemented—unverified** | Owned settings/history source, migrations 004/005, typed contracts, real PostgreSQL probes, and authenticated local-browser acceptance pass. Hosted migrations/deployment were not performed and remain release-gated. |
