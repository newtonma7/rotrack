    ...
    <div className="min-h-screen bg-[var(--rt-cream)] text-[var(--rt-ink)]">
      ...
      <main className="mx-auto max-w-[1400px] px-6 py-10 md:px-10 md:py-14">
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[minmax(260px,0.75fr)_minmax(0,1.5fr)]">
          <aside aria-label="Notes library" className={`${selectedNoteId || mobileDraft ? "hidden lg:block" : ""} group relative overflow-hidden rounded-[32px] border border-[var(--rt-line)] bg-[var(--rt-paper)] p-5 md:p-6`}>
            <span aria-hidden="true" className="pointer-events-none absolute -right-16 -top-16 size-40 rounded-full bg-[var(--rt-orange)] opacity-[0.06] transition-transform duration-500 group-hover:scale-110" />
            ...
            <label htmlFor="note-entry-filter" className="relative mt-4 block text-sm font-semibold">Exact time entry</label>
