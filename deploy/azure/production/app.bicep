...
@description('Existing production ACR name created by foundation.bicep.')
@minLength(5)
@maxLength(50)
...
@description('Exact HTTPS Vercel Production origin(s), comma-separated.')
@minLength(1)
param corsAllowedOrigins string

var managedEnvironmentName = 'rotrack-production-env'
var containerAppName = 'rotrack-api-production'
