...
@description('Azure region for every non-production resource.')
param location string

@description('Globally unique ACR name. The adapter requires a rotracknonproduction* name.')
@minLength(5)
@maxLength(50)
...
var workspaceName = 'rotrack-nonproduction-logs'
...
resource budget 'Microsoft.Consumption/budgets@2023-05-01' = {
  name: 'rotrack-nonproduction-budget'
  properties: {
    category: 'Cost'
    amount: budgetAmount
    timeGrain: 'Monthly'
